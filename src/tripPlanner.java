...
public class tripPlanner {
    public static void main(String[] args) {
        ...
        double lon1= input.nextDouble()*(Math.PI/180);
        ...
        System.out.println("Ideally it would be a "+(dis/900)+" hr long flight.");
        System.out.println("Thankyou for using this program. Have a safe journey.");
